...
//
//JNICALL
//Java_com_project_opencvperson_MainActivity_stringFromJNI(
//        JNIEnv *env,
//        jobject /* this */) {
...
//Java_com_project_opencvperson_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance,
//                                                            jlong matAddrInput,
//                                                            jlong matAddrResult) {
//
//
...
Java_com_project_opencvperson_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_project_opencvperson_MainActivity_detect(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_project_opencvperson_MainActivity_FileSize(JNIEnv *env, jobject instance) {
